...
Scene.prototype.generatePlanets = function(conquerors,
  ...
  var maps =  [
    ...
    [
      { x: 100, y: 100, ratio: 5, ships: 3 },
      { x: 650, y: 300, ratio: 5, ships: 45 },
      { x: 500,  y: 100, ratio: 1, ships: 5 },
      { x: 300, y: 210, ratio: 4, ships: 25 },
      { x: 170,  y: 230, ratio: 1, ships: 1 },
      { x: 600,  y: 200, ratio: 1, ships: 1 },
      { x: 450,  y: 270, ratio: 6, ships: 1 },
      { x: 100, y: 300, ratio: 2, ships: 10 },
      { x: 50,  y: 200, ratio: 1, ships: 1 },
      { x: 50, y: 50, ratio: 3, ships: 3 },
      { x: 220,  y: 310, ratio: 1, ships: 1 },
      { x: 400, y: 150, ratio: 7, ships: 25 },
      { x: 270, y: 70, ratio: 4, ships: 25 },
      { x: 200, y: 150, ratio: 3, ships: 200 }
    ],
    [
      { x: 400,  y: 160, ratio: 1, ships: 1 },
      { x: 320,  y: 140, ratio: 1, ships: 1 },
      { x: 270,  y: 210, ratio: 1, ships: 1 },
      { x: 400,  y: 240, ratio: 1, ships: 1 },
      { x: 330,  y: 270, ratio: 1, ships: 1 },
      { x: 50,  y: 30, ratio: 3, ships: 1 },
      { x: 50,  y: 120, ratio: 3, ships: 1 },
      { x: 50,  y: 220, ratio: 3, ships: 1 },
      { x: 50,  y: 320, ratio: 3, ships: 1 },
      { x: 650,  y: 30, ratio: 3, ships: 1 },
      { x: 650,  y: 120, ratio: 3, ships: 1 },
      { x: 650,  y: 220, ratio: 3, ships: 1 },
      { x: 650,  y: 320, ratio: 3, ships: 1 },
      { x: 550,  y: 30, ratio: 1, ships: 1 },
      { x: 550,  y: 120, ratio: 1, ships: 1 },
      { x: 550,  y: 220, ratio: 1, ships: 1 },
      { x: 550,  y: 320, ratio: 1, ships: 1 },
      { x: 150,  y: 30, ratio: 1, ships: 1 },
      { x: 150,  y: 120, ratio: 1, ships: 1 },
      { x: 150,  y: 220, ratio: 1, ships: 1 },
      { x: 150,  y: 320, ratio: 1, ships: 1 },
    ]
  ];
